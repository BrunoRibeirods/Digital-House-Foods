...
class RestauranteAdapter(private val listaDeRestaurantes: ArrayList<Restaurante>): RecyclerView.Adapter<RestauranteAdapter.CardRestaurante>() {
    ...
    class CardRestaurante(itemView: View): RecyclerView.ViewHolder(itemView){
